...
**Защита от споров:** если покупатель не подтверждает получение в течение 48 часов после передачи продавцом, средства автоматически освобождаются продавцу (job-воркер `processAutoReleases`).
