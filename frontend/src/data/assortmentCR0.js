export const CATALOG_RAW_0 = `Steam|Steam|steam|a
Telegram|Telegram|telegram|a
Cursor|Cursor|cursor|a
TradingView|TradingView|tradingview|a
Apple|Apple|apple|a
PlayStation|PlayStation|playstation|a
ЧатГПТ|ChatGPT|chatgpt|a
Claude|Claude|claude|a
TikTok|TikTok|tiktok|a
Discord|Discord|discord|a
Spotify|Spotify|spotify|a
YouTube|YouTube|youtube|a
Google Play|Google Play|google-play|a
Xbox|Xbox|xbox|a
Gemini (Nano Banana)|Gemini|gemini-nano-banana|a
Faceit|FACEIT|faceit|a
Adobe|Adobe|adobe|a
Battle.net|Battle.net|battlenet|a
Grok|Grok|grok|a
Nintendo|Nintendo|nintendo|a
Suno|Suno|suno|a
CapCut|CapCut|capcut|a
Windows|Windows|windows|a
Rockstar Games|Rockstar|rockstar-games|a
Другие приложения|Другие приложения|other-apps|a
Kimi|Kimi|kimi|a
