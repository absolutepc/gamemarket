...
import { CATALOG_RAW_3 } from './assortmentCR3';
import { CATALOG_RAW_4 } from './assortmentCR4';
...
export function buildHomeCarousel(items, popularNames = []) {
  ...
  for (const p of HOME_CAROUSEL_PINNED) push(byName.get(p.name) || byName.get(p.catalog));
...
export const ASSORTMENT_ICON_VERSION = '20260805-revert';
