...
function isCrosshairX(name, search = '') {
  const n = normalizeName(name);
  const s = normalizeName(search);
  return (
    n === 'crosshair x'
    || n === 'crosshairx'
    || n.startsWith('crosshair x ')
    || s.includes('crosshair x')
    || s.includes('crosshairx')
  );
}
...
function isRecraft(name, search = '') {
  const n = normalizeName(name);
  const s = normalizeName(search);
