...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Комиссия зависит от категории: 7.5% для доната, подписок, пополнения баланса, ключей, скинов и игр; 17.5% для аккаунтов, предметов, валюты и остальных товаров. Удерживается при выплате продавцу. За вывод средств площадка комиссию не берёт.',
  },
  {
