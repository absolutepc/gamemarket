...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Комиссия зависит от категории: 7.5% для подписок, пополнений, подарочных карт и ИИ-сервисов; 17.5% для аккаунтов, предметов, валюты и остальных товаров. Удерживается при выплате продавцу. За вывод средств площадка комиссию не берёт.',
  },
  {
